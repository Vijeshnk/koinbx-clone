...
const Features = () => (
  <section className="bg-white dark:bg-[#131932] py-16">
    <div className="max-w-7xl mx-auto px-4">
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white text-left mb-4">
        Salient Features of KoinBX
      </h2>
      <p className="text-base text-gray-600 dark:text-[#8F9194] text-left mb-10 max-w-3xl">
